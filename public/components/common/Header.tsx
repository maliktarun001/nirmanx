...
<div className="gap-10 items-center hidden lg:flex"><button className="cursor-pointer font-bold text-blue text-base leading-normal lg:flex hidden">Sign In</button>
